...
mongo_client = MongoClient("mongodb+srv://bharathr207:Bharath2K15@cluster0.yukjotk.mongodb.net/?retryWrites=true&w=majority")
db = mongo_client['youtube_data']
collection1 = db['channel_details']
collection2 = db['video_details']
collection3 = db['comments_details']

api_key = 'AIzaSyDw_CpDYsyP6tn4Y1ZwuoYmKWjOD-QAjA8'
